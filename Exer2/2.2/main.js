...
function mouseClick(event){
    ...
    if ((mode === "r" && click.length >= 2) || (mode === "t" && click.length >= 3)) {
        click = [];
    }
    ...
    if (click.length === 1) {
        ...
        const r1 = bresenham(p1.x, p1.y, p2.x, p2.y);
        const r2 = bresenham(p2.x, p2.y, p3.x, p3.y);
        const r3 = bresenham(p3.x, p3.y, p1.x, p1.y);

        pontosParaDesenhar = [...r1, ...r2, ...r3];
    }
